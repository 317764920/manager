...
import com.lcx.mysdk.utils.ThreadPoolManager;
...
//        this.bindTouch(this, chart);
    ...
    private void chartRender() {
        try {
            ...
            chart.setPadding(0, ltrb[1], right, ltrb[3]);
            ...
            chart.getLabelPaint().setTextSize(DensityUtils.sp2px(getContext(), 15));
            ...
            legend.show();
            legend.getPaint().setTextSize(DensityUtils.sp2px(getContext(), 15));
    ...
    private void chartDataSet() {
		...
		*/
        ...
        chartData.add(new PieData("保养", "9%", 9, Color.rgb(155, 187, 90)));
        chartData.add(new PieData("维修", "3%", 3, Color.rgb(191, 79, 75)));
        chartData.add(new PieData("巡检", "76%", 76f, Color.rgb(242, 167, 69)));
        chartData.add(new PieData("其他", "12%", 12, Color.rgb(60, 173, 213)));
