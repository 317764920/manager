...
public class QrCodeActivity extends Activity implements Callback, View.OnClickListener {
	...
	private void onResultHandler(String resultString) {
		if (TextUtils.isEmpty(resultString)) {
			Toast.makeText(QrCodeActivity.this, "识别错误", Toast.LENGTH_SHORT).show();
			return;
		}
