...
package com.lcx.mysdk.fragment;
...
public class ProgressFragment extends Fragment {
    ...
    public void setProgressText(CharSequence text){
    	ensureContent();
        if (mProgressText != null && mProgressText instanceof TextView) {
            ((TextView) mProgressText).setText(text);
        } else {
            throw new IllegalStateException("Can't be used with a custom progressText view");
        }
    }
    ...
    private void ensureContent() {
        ...
        mProgressText = root.findViewById(R.id.progress_text);
        if (mProgressContainer == null) {
            throw new RuntimeException("Your content must have a ViewGroup whose id attribute is 'R.id.progress_text'");
        }
        mContentShown = true;
