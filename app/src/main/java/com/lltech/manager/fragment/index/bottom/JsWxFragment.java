...
/**
 * @ClassName(类名) : JsWxFragment
 * @Description(描述) : 技术端待维修
 * @author(作者) ：liuchunxu
 * @date (开发日期) ：2015年8月26日 下午4:10:04
 */
public class JsWxFragment extends BaseProgressFragment {
...
//                        break;
    ...
    private void refresh() {
        String url = UrlCons.url(UrlCons.DistributionService.GET_REPAIR_LIST);
        PgReq req = new PgReq();
