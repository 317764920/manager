...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    @Override
    public final void onRefreshComplete(boolean isOK) {
        getLoadingLayoutProxy().setPullToRefreshAreaVisable(false);
        getLoadingLayoutProxy().setRefreshingLabel(getResources().getString(R.string.pull_to_refresh_ok));
        if (isOK) {
            ...
            },getResources().getInteger(R.integer.delay_time));
        } else {
            if (isRefreshing()) {
                setState(State.RESET);
            }
