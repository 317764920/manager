...
/**
 *
 * @Description(功能描述)    : okhttp请求工具类
 * @author(作者)         ：liuchunxu
 * @date (开发日期)      ：2016-04-01 17:25
 *
 */
public class OkHttpUtils {
    ...
    public class DownloadDelegate {
         ...
         * @param callback
         */
        public void downloadAsyn(final String url, final String newFilename, final String destFileDir, final ResultCallback callback) {
            final Request request = new Request.Builder()
                    .url(url)
                    .build();
