...
public class TabIndicatorView extends LinearLayout implements View.OnTouchListener {
	...
	public void setupLayout(List<String> textList) {
		...
		final List<View> list = new LinkedList<View>();
	...
	private void refreshItemView(View view, boolean isCurrent) {
		...
		if (isCurrent) {
			textView.setTextColor(resources.getColor(R.color.style_text));
			textView.setBackgroundResource(R.color.white);
			line.setVisibility(View.VISIBLE);
		} else {
			textView.setTextColor(resources.getColor(R.color.gray));
			textView.setBackgroundResource(R.color.backgroundcolor);
