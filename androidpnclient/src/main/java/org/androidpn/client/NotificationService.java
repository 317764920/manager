...
public class NotificationService extends Service {
	...
	public void onCreate() {
		...
		sharedPrefs = getSharedPreferences(Constants.SHARED_PREFERENCE_NAME, Context.MODE_MULTI_PROCESS);
	...
	private void registerNotificationReceiver() {
		...
		filter.addAction(sharedPrefs.getString(Constants.PACKEGE, Constants.PACKEGE) + Constants.ACTION_SHOW_NOTIFICATION);
		filter.addAction(sharedPrefs.getString(Constants.PACKEGE, Constants.PACKEGE) + Constants.ACTION_NOTIFICATION_CLICKED);
		filter.addAction(sharedPrefs.getString(Constants.PACKEGE, Constants.PACKEGE) + Constants.ACTION_NOTIFICATION_CLEARED);
