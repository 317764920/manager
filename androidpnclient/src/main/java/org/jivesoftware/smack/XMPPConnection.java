...
/**
 * 
  * @ClassName(类名)      : XMPPConnection
  * @Description(描述)    : 修改：加入启动心跳方法
  * @author(作者)         ：liuchunxu
  * @date (开发日期)      ：2015年6月19日 上午9:28:00
  *
 */
...
//        username = username.toLowerCase().trim();
    ...
    /**
     * 
     * @Description(功能描述)    :  启动心跳
     * @author(作者)             ：  liuchunxu
     * @date (开发日期)          :  2015年6月19日 上午9:27:39 
     * @exception                :   void
     */
    public void startHeartBeat(long keepTime){
    	packetWriter.startHeartBeatThread(keepTime);
    }
}
