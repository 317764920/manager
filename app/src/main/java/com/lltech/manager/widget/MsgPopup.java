...
import com.lltech.manager.entity.ActionItem;

import java.util.ArrayList;

/**
 * @ClassName(类名) : MsgPopup
 * @Description(描述) : 标记消息已读未读
 * @author(作者) ：liuchunxu
 * @date (开发日期)      ：2016年06月01日 13:19
 */
...
//        this(context, LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
    ...
    public MsgPopup(Context context, int width, int height) {
...
//		mScreenHeight = Util.getScreenHeight(mContext);
        ...
        setContentView(view);
        read = (TextView) view.findViewById(R.id.popu_read);
    }
    ...
    public void setRead(TextView read) {
        this.read = read;
    }
    ...
    public void show(final View c) {
        ...
        showAtLocation(c, Gravity.NO_GRAVITY, mLocation[0] - (this.getWidth()-c.getWidth())/2, mLocation[1] - (this.getHeight() - c.getHeight()) / 2);
    }
