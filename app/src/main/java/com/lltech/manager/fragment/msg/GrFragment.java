...
/**
 * @ClassName(类名) : GrFragment
 * @Description(描述) : 个人消息
 * @author(作者) ：liuchunxu
 * @date (开发日期)      ：2016年05月18日 09:50
 */
public class GrFragment extends BaseFragment implements View.OnClickListener, MsgView {
    ...
    public void initView() {
        ...
        msgPopup = new MsgPopup(application, DensityUtils.dp2px(application, 150), DensityUtils.dp2px(application, 40));
    ...
    public void initListener() {
        pullToRefreshListView.setOnRefreshListener(new PullToRefreshBase.OnRefreshListener2<ListView>() {
            ...
            public void onPullDownToRefresh(PullToRefreshBase<ListView> refreshView) {
                baseBiz.getMsgList(Req.PULL_DOWN, "Personal_meg", "0");
            }

            @Override
            public void onPullUpToRefresh(PullToRefreshBase<ListView> refreshView) {
                baseBiz.getMsgList(Req.PULL_UP, "Personal_meg", "0");
            }
        });
                        ...
                        popupMenu.setOnItemClickListener(new PopupMenu.OnItemClickListener() {
                            ...
                            public void onItemClick(PopMenuItem item, int position) {
                                switch (position) {
                                    ...
                                    case 1: {
                                        //已读消息1
                                        baseBiz.getMsgList(Req.PULL_DOWN, "Personal_meg", "1");
                                        break;
                                    }
                                }
                            }
