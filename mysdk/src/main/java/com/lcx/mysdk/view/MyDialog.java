...
public class MyDialog {
	...
	public MyDialog setBackground(Drawable drawable) {
	...
	public MyDialog setBackgroundResource(int resId) {
	...
	public MyDialog setPositiveButton(int resId, final View.OnClickListener listener) {
	...
	public MyDialog setPositiveButton(String text, final View.OnClickListener listener) {
		mPositiveButton = new Button(mContext);
		LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.WRAP_CONTENT,
				LinearLayout.LayoutParams.WRAP_CONTENT);
		mPositiveButton.setLayoutParams(params);
	...
	public MyDialog setNegativeButton(int resId, final View.OnClickListener listener) {
	...
	public MyDialog setNegativeButton(String text, final View.OnClickListener listener) {
		mNegativeButton = new Button(mContext);
		mLayoutParams = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.WRAP_CONTENT, LinearLayout.LayoutParams.WRAP_CONTENT);
		mNegativeButton.setLayoutParams(mLayoutParams);
		mNegativeButton.setBackgroundResource(R.drawable.button);
	...
	private class Builder {
		...
		private Builder() {
			...
			// mAlertDialogWindow.setContentView(R.layout.layout_MyDialog);

			// 7
			WindowManager.LayoutParams params = new WindowManager.LayoutParams(WindowManager.LayoutParams.WRAP_CONTENT,
					WindowManager.LayoutParams.WRAP_CONTENT, WindowManager.LayoutParams.TYPE_PHONE, WindowManager.LayoutParams.FLAG_ALT_FOCUSABLE_IM,
